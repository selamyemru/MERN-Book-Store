...
//     const id = params.id
//     try {
//       const resposne = await axios.get(`http://localhost:4000/getbook/` + id)
//       setBookDetail(resposne.data)
...
//       <BackButton/>
//       <h1 className='text-green-800 font-semibold text-xl'>Book Detail</h1>
//       {bookDetail &&
//         <div className='mt-6 border-2 boreder-gray-200 p-10 shadow-lg shadow-orange-50'>
//           <div className='flex gap-5 pb-4'>
//             <span><img src={bookDetail.image} /></span>
//           </div>
